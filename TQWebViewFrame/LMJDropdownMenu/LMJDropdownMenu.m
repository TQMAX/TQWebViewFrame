...
//    [_mainBtn setTitleColor:WhiteColor forState:UIControlStateNormal];
//    [_mainBtn setTitle:@"。。。" forState:UIControlStateNormal];
    [_mainBtn setImage:[UIImage imageNamed: _btnImgName] forState:UIControlStateNormal];
...
//    _mainBtn.contentHorizontalAlignment = UIControlContentHorizontalAlignmentRight;
    _mainBtn.titleLabel.font    = Font(14);
//    _mainBtn.titleEdgeInsets    = UIEdgeInsetsMake(0, 0, 0, 0);
    ...
    // 旋转尖头
    _arrowMark = [[UIImageView alloc] initWithFrame:CGRectMake(_mainBtn.frame.size.width , 0, 9, 9)];
    _arrowMark.center = CGPointMake(VIEW_CENTER_X(_arrowMark), VIEW_HEIGHT(_mainBtn)/2);
    _arrowMark.image  = [UIImage imageNamed:@"dropdownMenu_cornerIcon.png0"];
